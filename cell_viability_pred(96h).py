...
xTrain,xValidation,xTest,yTrain,y
Validation,yTest = getData()
...
T = 30                  #The maximum number of iterations
...
#Saving the model
import pickle
gene_files = open(r"model_adjust\Achilles-L1000-96h_GeneSelection_1","w")
gene_files.write(str(selected_genes_dict))
gene_files.close()
pickle.dump(xgboost_best_model,open(r"model_adjust\Achilles-L1000-96h_XGBoost_1.dat","wb"))