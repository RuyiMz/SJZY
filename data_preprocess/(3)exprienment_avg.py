# -*- coding: utf-8 -*-
"""
Created on Sun Aug 18 13:36:34 2019
...
record = 0
LINCS_PhaseII_CTRP_file = open("LINCS_PhaseII_CTRP/LINCS_PhaseII_CTRP_dosetemp_24h.txt","w")
LINCS_PhaseII_CTRP_file.write("record\t"+"signature\t"+"cell_line\t"+"drug\t"+"dose\t"+"time\t"+"cell_viability\n")


LINCS_PhaseII_CTRP =pd.read_table(r"LINCS_PhaseII_CTRP\LINCS_PhaseII_CTRP_dose_24h.txt",sep="	");
