...
D = 48                 #The number of particles in the group
...
#Saving the model
import pickle
gene_files = open(r"model_adjust\Achilles-L1000-144h_GeneSelection_1","w")
gene_files.write(str(selected_genes_dict))
gene_files.close()
pickle.dump(xgboost_best_model,open(r"model_adjust\Achilles-L1000-144h_XGBoost_1.dat","wb"))